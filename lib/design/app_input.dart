...
import 'package:app/design/app_image.dart';
...
class AppInput extends StatefulWidget {
  ...
  const AppInput({
    ...
    this.controller,
    this.validator,
    this.prefixIcon, this.inputType=InputType.normal,
  });
    ...
    return Padding(
      ...
      child:IntrinsicHeight(
        child: TextFormField(
          ...
          obscureText: isHidden && widget.inputType==InputType
              .password,
          ...
          decoration: InputDecoration(
              ...
              icon: widget.inputType==InputType.phone?Container(
                ...
                child: Column(
                  ...
                  children: [
                    Expanded(child: AppImage("saudi.png",
                      width: 32.w,
                      height: 20.h,)),
                    SizedBox(height: 4.h,),
